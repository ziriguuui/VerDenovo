  ...
  return (
    <button
      ...
      style={{
        ...
        opacity: disabled ? 0.5 : 1, transition: 'all 0.2s ease', ...v,
      }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '5rem 0 3rem' }}>
        ...
        <div className="mb-5 position-relative overflow-hidden animate-fadeInUp" style={{ background: 'linear-gradient(135deg, #14532d 0%, #166534 40%, #15803d 100%)', borderRadius: '28px', padding: '4rem 2rem 3.5rem', border: '2px solid rgba(74,222,128,0.2)', boxShadow: '6px 6px 0px rgba(0,0,0,0.14), 0 16px 48px rgba(0,0,0,0.10)' }}>
          ...
          <div className="text-center position-relative" style={{ zIndex: 2 }}>
            <div className="d-inline-flex align-items-center px-4 py-2 rounded-pill mb-4 animate-fadeInUp" style={{ background: 'rgba(255,255,255,0.15)', color: 'rgba(255,255,255,0.9)', fontWeight: 700, fontSize: '0.78rem', letterSpacing: '0.08em', textTransform: 'uppercase', border: '2px solid rgba(255,255,255,0.2)', backdropFilter: 'blur(8px)' }}>
            ...
            <h1 className="animate-fadeInUp animate-delay-1" style={{ fontSize: 'clamp(2.6rem, 5.5vw, 4.2rem)', lineHeight: '1.05', color: '#ffffff', letterSpacing: '-0.04em', fontWeight: 800, marginBottom: '1rem' }}>
              Pontos de <span style={{ color: '#6ee7b7' }}>Coleta</span>
            </h1>
            <p className="animate-fadeInUp animate-delay-2" style={{ fontSize: '1.05rem', lineHeight: '1.8', maxWidth: '460px', margin: '0 auto 2.75rem', color: 'rgba(255,255,255,0.6)', fontWeight: 300 }}>
              ...
              {[
                ...
                <div key={i} className="d-flex align-items-center gap-3 px-4 py-3 rounded-4"
                  ...
                  <div className="text-start">
                    ...
                    <div style={{ color: '#6b7280', fontSize: '0.73rem', fontWeight: 500, marginTop: '3px' }}>{s.label}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="mb-5 animate-fadeInUp animate-delay-3">
          <div className="d-flex gap-3 mb-3">
            ...
            {(busca || filtroMateriais.length > 0) && (
              <button className="btn fw-semibold px-4"
                ...
                style={{ borderRadius: '14px', border: '2px solid rgba(252,165,165,0.6)', background: 'rgba(254,226,226,0.7)', color: '#ef4444', height: '58px', whiteSpace: 'nowrap', fontSize: '0.85rem', flexShrink: 0 }}>
          ...
          <div className="d-flex flex-wrap gap-2 align-items-center">
            ...
            {Object.entries(materialConfig).map(([nome, cfg]) => (
              <FilterChip key={nome} nome={nome} cfg={cfg} ativo={filtroMateriais.includes(nome)} onClick={() => toggleMaterial(nome)} />
            ))}
            {(busca || filtroMateriais.length > 0) && (
        ...
        {loading && (
          <div className="text-center py-5 my-4">
            <div className="spinner-border text-success mb-3" style={{ width: '2rem', height: '2rem' }}></div>
        ...
        {!loading && erro && (
          <div className="text-center py-5 my-4">
            ...
            <h5 className="fw-bold mb-2 mt-3">Ops, algo deu errado</h5>
            <p className="text-muted mb-4">{erro}</p>
        ...
        <>
          ...
          <div
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" style={{ margin: '1.5rem auto' }}>
              <div className="modal-content modal-pontos-content border-0" style={{ borderRadius: '28px', overflow: 'hidden', boxShadow: '8px 8px 0px rgba(0,0,0,0.15), 0 32px 80px rgba(0,0,0,0.20)', border: '2px solid rgba(255,255,255,0.6)', maxHeight: '90vh', display: 'flex', flexDirection: 'column' }}>

                {/* Header */}
                <div style={{ background: 'linear-gradient(135deg, #052e16 0%, #064e3b 50%, #065f46 100%)', padding: '2.25rem 2rem 2rem', flexShrink: 0 }}>
                  <div className="d-flex align-items-center gap-3">
                    <div className="d-flex align-items-center justify-content-center flex-shrink-0"
                      style={{ width: '64px', height: '64px', borderRadius: '20px', background: 'rgba(255,255,255,0.12)', border: '1.5px solid rgba(255,255,255,0.2)' }}>
                    ...
                    <div className="flex-grow-1" style={{ minWidth: 0 }}>
                      ...
                      <p style={{ color: 'rgba(255,255,255,0.45)', fontWeight: 400, fontSize: '0.8rem', margin: 0 }}>
                ...
                {/* Stats bar */}
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.75rem', borderBottom: '1px solid #f0f0f0', background: '#f8fafc', padding: '1.25rem 1.5rem', flexShrink: 0 }}>
                  {[
                    ...
                    <div key={i} style={{ background: 'white', borderRadius: '14px', padding: '1rem 0.75rem', textAlign: 'center', border: `1.5px solid ${item.border}`, boxShadow: '0 2px 8px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-12 col-md-6">
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '1.25rem', paddingBottom: '0.6rem', borderBottom: '2px solid #f0fdf4' }}>
                        ...
                        <h6 style={{ color: '#0f172a', fontWeight: 700, fontSize: '0.9rem', margin: 0 }}>Localização</h6>
                      </div>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        ...
                        {pontoSelecionado.complemento && (
                          <LocationField label="Complemento" icon="bi-building" value={pontoSelecionado.complemento} />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="col-12 col-md-6">
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '1.25rem', paddingBottom: '0.6rem', borderBottom: '2px solid #f0fdf4' }}>
                        ...
                        <h6 style={{ color: '#0f172a', fontWeight: 700, fontSize: '0.9rem', margin: 0 }}>Materiais Aceitos</h6>
                      </div>
                      {(() => {
                        ...
                        return (
                          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                            {lista.map((mat, i) => {
                              ...
                              return (
                                <span key={i} style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '6px 13px', borderRadius: '999px', background: p.bg, border: `1.5px solid ${p.border}`, color: p.text, fontSize: '0.78rem', fontWeight: 600 }}>
                                  <span style={{ fontSize: '0.95rem', lineHeight: 1 }}>{cfg.emoji}</span>{mat}
                                </span>
                              );
                            })}
                          </div>
                    ...
                    {pontoSelecionado.descricao && (
                      <div className="col-12">
                        <div style={{ background: '#fffbeb', borderRadius: '14px', padding: '1.25rem 1.5rem', border: '1px solid #fde68a' }}>
                          ...
                          <p style={{ margin: 0, color: '#78716c', fontSize: '0.88rem', lineHeight: '1.75' }}>{pontoSelecionado.descricao}</p>
                        </div>
                      </div>
                    )}
                ...
                {/* Footer — "Abrir no Google Maps" REMOVIDO, só "Como Chegar" */}
                <div style={{ padding: '0 2rem 2rem', display: 'flex', gap: '0.75rem', flexWrap: 'wrap', flexShrink: 0, borderTop: '1px solid #f1f5f9' }}>
                  <ModalButton
